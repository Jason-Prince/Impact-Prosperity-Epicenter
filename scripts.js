...
window.addEventListener("load", function () {
  ...
  // create div for title elements and append it to container
  const title_container = document.createElement("div");
  title_container.className = "title";

  // title text elements
  const company = document.createElement("p");
  company.innerText = "University of Utah";
  title_container.appendChild(company);

  const project = document.createElement("p");
  project.innerText = "Impact Prosperity Epicenter";
  title_container.appendChild(project);

  const latitude_study = document.createElement("p");
  latitude_study.innerText = "Latitude Study Phase 2";
  title_container.appendChild(latitude_study);

  const date = document.createElement("p");
  date.innerText = "02/07/2022";
